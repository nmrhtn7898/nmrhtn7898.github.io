...
![대체 텍스트](/assets/images/2020-07-18-3-image-1.png)

* 유레카 서버의 구동 후 볼 수 있는 유레카 서버 메인(대시보드) 화면이다.
* 서버의 구동 정보와 현재 사용 중이고 가용한 자원 정보와 등록된 서비스 인스턴스 정보를 확인할 수 있다.

![대체 텍스트](/assets/images/2020-07-18-3-image-2.png)

![대체 텍스트](/assets/images/2020-07-18-3-image-3.png)
...
* 리본을 지원하는 RestTemplate 인스턴스를 생성 후 빈으로 등록하여 유레카 서버에 등록된 서비스 호출 시, 서비스 ID를 통한 서비스 디스커버리와 리본의 클라이언트측 로드 밸런싱을 활용할 수 있다.
