...
한 value 값을 접근할 수 있다.
* 객체의 고유한 레퍼런스 값을 해싱하고 해시 주소로 사용하여 엔트리(연결리스트)로 체이닝하여 저장하고 사용한다.
...
![로그 이미지](/assets/images/2020-07-09-1-image-1.png)

* 한 쓰레드에서 두개의 ThreadLocal을 사용하였을 때 ThreadLocalContext를 통해 ThreadLocal에 데이터를 설정하고
